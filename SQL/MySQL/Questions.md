...
- **InnoDB**存储引擎
  ...
  > InnoDB操作数据的单位是页(16KB)
  
  ![1619337563205](../../media/1619337563205.png)
  
  ![1619343781077](../../media/1619343781077.png)
...
>
> 每个session生成的readview是针对整个数据库的所有表，而不是某个表

![1619335205256](../../media/1619335205256.png)

![1619334879978](../../media/1619334879978.png)



![1619334434680](../../media/1619334434680.png)

![1619335366723](../../media/1619335366723.png)



- **可重复读**：同一个session，select时会延用第一次可重复读查询语句生成的readview(快照一致性视图)，从中找到结果集并返回
- **读已提交**：同一个session，每次select时都会按最新的情况再生成一次readview
